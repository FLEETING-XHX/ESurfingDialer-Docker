...
object RuntimeConfig {
    ...
    val portalDetectionThreshold: Int = envInt("PORTAL_DETECTION_THRESHOLD", 3, 1, 20)
    ...
    val healthAuthMaxAgeSeconds: Long = envLong("HEALTH_AUTH_MAX_AGE_SECONDS", 300, 30, 3600)
